...
/**
 * Lindexplus with no posting splitting
 * @author dayuyuan
 *
 */
public class SubSearch_LindexSimplePlus implements ISearcher {
	...
	public SubSearch_LindexSimplePlus(SearchableIndexAdvInterface indexSearcher,
	...
	/**
	 * Load the on disk index, TimeComponent[2], index lookup time
	 * 
	 * @param in_memoryFeatureID
	 * @param TimeComponent
	 * @return
	 */
	private LindexSearcher loadOndiskIndex(int in_memoryFeatureID, SearchStatus status) {

...
public class ArrayIterator implements Iterator {
	 ...
	 *         the no-arg constructor was used and {@link #setArray(Object)} has
	 *         never been called with a valid array.
	 */
	 ...
	 * 
	 * If an array has previously been set (using the single-arg constructor or
	 * this method) then that array is discarded in favour of this one.
	 * Iteration is restarted at the start of the new array. Although this can
	 * be used to reset iteration, the {@link #clear()} method is a more
	 * effective choice.
	 * 
	 * @param array
